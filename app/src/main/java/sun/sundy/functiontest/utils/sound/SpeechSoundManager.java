package sun.sundy.functiontest.utils.sound;
...
import sun.sundy.functiontest.utils.ApkUtil;
...
public class SpeechSoundManager {
    ...
    public void startSpeech(String speechContext) throws Exception {
        ...
        if (mTts != null && speechContext != null && speechContext.length() > 0) {
            ...
            ToastUtils.showLazzToast(speechContext);
        }
    }
    ...
    private void setParam() {
        ...
        // 设置发音人
        mTts.setParameter(SpeechSynthesizer.VOICE_NAME,"jaijia");
        // 设置语速
